...
class MuSTRec(GeneralRecommender):
    def __init__(self, item_embeddings, user_embeddings, config, dataset):
        super(MuSTRec, self).__init__(config, dataset)

        self.user_embedding = user_embeddings
        self.item_id_embedding = item_embeddings
    ...
    def calculate_loss(self, interaction):
        ...
        return self.uigraph_weight * batch_mf_loss + self.reg_weight * (mf_t_loss + mf_v_loss)
