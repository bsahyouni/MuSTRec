...
class RecDataset(object):
    def __init__(self, config, df=None):
        ...
        if config['model'] == 'SSG':
            subseq_file_path = '/home/bs00826/Downloads/MMRec-master/data/baby'
    ...
    def load_subseq_map(self, subseq_file_name):
        """
        ...
        self.logger.info(f"Loaded {self.n_subseq} subsequences from {subseq_file_name}.")
